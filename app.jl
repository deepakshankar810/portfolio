...
function home()
    ...
    <body class="antialiased overflow-hidden h-screen h-[100dvh] flex flex-col bg-slate-50 dark:bg-[#0B1120] text-slate-700 dark:text-slate-300">
        ...
        <nav class="w-full z-50 bg-white/90 dark:bg-[#0B1120]/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 flex-shrink-0 relative">
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center justify-between h-20">
                    ...
                    <div class="flex-1 flex items-center overflow-x-auto no-scrollbar mask-gradient mr-4 pointer-events-none">
                        <div class="flex space-x-1 md:space-x-6">
                            <button onclick="switchTab('home')" class="nav-btn active text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">Home</button>
                            <button onclick="switchTab('about')" class="nav-btn text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">About</button>
                            <button onclick="switchTab('skills')" class="nav-btn text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">Skills</button>
                            <button onclick="switchTab('projects')" class="nav-btn text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">Projects</button>
                            <button onclick="switchTab('manuscripts')" class="nav-btn text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">Publications</button>
                            <button onclick="switchTab('certifications')" class="nav-btn text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">Certifications</button>
                            <button onclick="switchTab('contact')" class="nav-btn text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-400 transition px-3 py-2 text-sm font-medium whitespace-nowrap pointer-events-auto">Contact</button>
                        </div>
                    </div>

                    <!-- RIGHT SIDE: CV & Theme Switcher -->
                    <div class="flex-shrink-0 pl-4 border-l border-gray-200 dark:border-gray-700 flex items-center space-x-2 relative z-[100]">
                        <button onclick="openCVPreview()" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition focus:outline-none transform hover:scale-110 active:scale-95 cursor-pointer" title="View CV">
                            <i class="fas fa-file-pdf text-teal-600 dark:text-teal-400 text-xl md:text-2xl"></i>
                        </button>
                        <button onclick="toggleTheme()" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition focus:outline-none transform hover:scale-110 active:scale-95 cursor-pointer" title="Toggle Theme">
            ...
            <div id="tab-home" class="tab-pane min-h-full flex items-center justify-center p-4 fade-in relative z-10">
                <div class="text-center w-full max-w-4xl">
                    ...
                    <div class="flex justify-center space-x-8 animate-slide-in" style="animation-delay: 0.3s">
                        <a href="$(PROFILE["github"])" target="_blank" class="text-3xl text-gray-400 dark:text-gray-500 hover:text-teal-600 dark:hover:text-teal-400 hover:drop-shadow-[0_0_12px_rgba(13,148,136,0.8)] dark:hover:drop-shadow-[0_0_12px_rgba(45,212,191,0.8)] transition-all duration-300 transform hover:scale-110 floating" style="animation-delay: 0s"><i class="fab fa-github"></i></a>
                        <a href="$(PROFILE["linkedin"])" target="_blank" class="text-3xl text-gray-400 dark:text-gray-500 hover:text-teal-600 dark:hover:text-teal-400 hover:drop-shadow-[0_0_12px_rgba(13,148,136,0.8)] dark:hover:drop-shadow-[0_0_12px_rgba(45,212,191,0.8)] transition-all duration-300 transform hover:scale-110 floating" style="animation-delay: 0.5s"><i class="fab fa-linkedin"></i></a>
                        <a href="mailto:$(PROFILE["email"])" class="text-3xl text-gray-400 dark:text-gray-500 hover:text-teal-600 dark:hover:text-teal-400 hover:drop-shadow-[0_0_12px_rgba(13,148,136,0.8)] dark:hover:drop-shadow-[0_0_12px_rgba(45,212,191,0.8)] transition-all duration-300 transform hover:scale-110 floating" style="animation-delay: 1s"><i class="fas fa-envelope"></i></a>
                    </div>
        ...
        <!-- CV Preview Modal -->
        <div id="cv-preview-modal" class="fixed inset-0 z-[70] hidden" role="dialog" aria-modal="true">
            <div class="absolute inset-0 bg-gray-900/60 dark:bg-black/80 backdrop-blur-sm transition-opacity duration-300 opacity-0 cv-modal-backdrop" onclick="closeCVPreview()"></div>
            <div class="absolute inset-0 flex items-center justify-center p-4 md:p-8 pointer-events-none">
                <div class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 w-full max-w-5xl h-[90vh] rounded-2xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0 cv-modal-panel pointer-events-auto flex flex-col">
                    <div class="p-4 md:p-6 border-b border-gray-100 dark:border-slate-700 flex justify-between items-center shrink-0">
                        <h3 class="text-xl font-bold text-teal-600 dark:text-teal-400 flex items-center">
                            <i class="fas fa-file-pdf mr-3"></i> Curriculum Vitae
                        </h3>
                        <div class="flex items-center space-x-3">
                            <a href="./CV/Deepak_CV.pdf?v=3" download="Deepak_CV.pdf" class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 dark:hover:bg-teal-500 text-white rounded-lg text-sm font-bold transition transform hover:scale-105 active:scale-95 shadow-md">
                                <i class="fas fa-download mr-2"></i> Download
                            </a>
                            <button onclick="closeCVPreview()" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-400 hover:text-gray-600 dark:hover:text-white transition">
                                <i class="fas fa-times text-lg"></i>
                            </button>
                        </div>
                    </div>
                    <div class="flex-1 overflow-hidden rounded-b-2xl bg-gray-100 dark:bg-slate-900">
                        <iframe src="./CV/Deepak_CV.pdf?v=3" class="w-full h-full border-0" title="CV Preview"></iframe>
                    </div>
                </div>
            </div>
        </div>
