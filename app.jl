    ...
    <body class="antialiased overflow-hidden h-screen h-[100dvh] flex flex-col bg-slate-50 dark:bg-[#0B1120] text-slate-700 dark:text-slate-300">
        ...
        <div id="cv-preview-modal" class="fixed inset-0 z-[70] hidden" role="dialog" aria-modal="true">
            ...
            <div class="absolute inset-0 flex items-center justify-center p-4 md:p-8 pointer-events-none">
                <div class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 w-full max-w-5xl h-[90vh] rounded-2xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0 cv-modal-panel pointer-events-auto flex flex-col relative">
                    <button onclick="closeCVPreview()" class="absolute -top-3 -right-3 md:-top-4 md:-right-4 bg-white dark:bg-slate-700 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-600 rounded-full shadow-xl z-10 border border-gray-200 dark:border-slate-600 transition flex items-center justify-center w-8 h-8 md:w-10 md:h-10">
                        <i class="fas fa-times text-base md:text-lg"></i>
                    </button>
                    <div class="flex-1 overflow-hidden rounded-2xl bg-gray-100 dark:bg-slate-900">
                        <iframe src="./CV/Deepak_CV.pdf?v=3" class="w-full h-full border-0 rounded-2xl" title="CV Preview"></iframe>
                    </div>
                </div>
            </div>
        </div>
