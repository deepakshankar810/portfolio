                ...
                <div class="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 w-full max-w-5xl h-[90vh] rounded-2xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0 cv-modal-panel pointer-events-auto flex flex-col">
                    <div class="p-4 md:p-6 border-b border-gray-100 dark:border-slate-700 flex justify-between items-center shrink-0">
                        ...
                        <div class="flex items-center space-x-3">
                            <a href="./CV/Deepak_CV.pdf?v=2" download="Deepak_CV.pdf" class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 dark:hover:bg-teal-500 text-white rounded-lg text-sm font-bold transition transform hover:scale-105 active:scale-95 shadow-md">
                    ...
                    <div class="flex-1 overflow-hidden rounded-b-2xl bg-gray-100 dark:bg-slate-900">
                        <iframe src="./CV/Deepak_CV.pdf?v=2" class="w-full h-full border-0" title="CV Preview"></iframe>
                    </div>
                </div>
            </div>
        </div>
