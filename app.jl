        ...
        <nav class="w-full z-50 bg-white/90 dark:bg-[#0B1120]/90 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 flex-shrink-0 relative">
            <div class="max-w-7xl mx-auto px-4">
                <div class="flex items-center justify-between h-20">
                    ...
                    <!-- RIGHT SIDE: Theme Switcher & CV -->
                    <div class="flex-shrink-0 pl-4 border-l border-gray-200 dark:border-gray-700 flex items-center space-x-2">
                        ...
                        <button onclick="openCVPreview()" class="p-2 rounded-full hover:bg-gray-200 dark:hover:bg-gray-800 transition focus:outline-none transform hover:scale-110 active:scale-95" title="View CV">
